...
set INC12=C:\CPP Libs\stb

set args=-I"%INC1%" -I"%INC2%" -I"%INC3%" -I"%INC4%" -I"%INC5%" -I"%INC6%" -I"%INC8%" -I"%INC9%" -I"%INC10%" -I"%INC11%" -I"%INC12%"
...
for /r "%INC2%\poly2tri" %%f in (*.cc) do (
    echo Compiling %%f
    clang++ -std=c++17 -g -c -I"%INC2%" "%%f" -o "build\obj\%%~nf.o"
)

    clang++ -std=c++17 -g -c -I"%INC8%" "%INC8%\simdjson.cpp" -o "build\obj\simdjson.o"
...
if "%1"=="imgui" (
    ...
    for %%f in ("%INC7%\imgui.cpp" "%INC7%\imgui_draw.cpp" "%INC7%\imgui_tables.cpp" "%INC7%\imgui_widgets.cpp") do (
        echo Compiling %%f
        clang++ -std=c++17 -g -c %args% %%f -o "build\obj\%%~nf.o"
    )

    clang++ -std=c++17 -g -c -I"%INC7%" -I"%INC4%" "%INC7%\backends\imgui_impl_opengl3.cpp" -o "build\obj\imgui_impl_opengl3.o"
    clang++ -std=c++17 -g -c -I"%INC7%" -I"%INC4%" "%INC7%\backends\imgui_impl_glfw.cpp" -o "build\obj\imgui_impl_glfw.o"
)
...
for /r "src" %%f in (*.cpp) do (
        echo Compiling %%f
        clang++ -std=c++17 -O0 -g -c %args% !build_defs! %%~ff -o "build\obj\%%~nf.o"
)

REM --- create library ---
clang++ -std=c++17 -g %args% -shared -o libgpp.dll build\obj\*.o %GLFW% -lopengl32 %GLEW% -lgdi32
endlocal